...
export default function AboutBannerBlock({
  bgImg,
  title,
  description,
  children,
  ...
  return (
    <Section
      tag="div"
      className={clsx(
        'container-fluid my-8 !px-0 md:!px-6 lg:my-10 2xl:!px-7 3xl:!px-8',
        sectionClassName,
      )}
    >
      <div
      ...
      >
        <Image
          ...
          className={clsx(
            'aspect-[18/5] bg-gray-lighter object-cover md:max-h-full',
            bgImgClassName,
          )}
          quality={100}
          fill
